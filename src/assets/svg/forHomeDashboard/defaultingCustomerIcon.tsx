...
export default function defaultingCustomerIcon() {
  return (
    <>
      <svg
      ...
      >
        ...
        />
        <path
          d="M12.2492 19.25H6.94876C5.76927 19.25 4.88912 18.2103 5.49008 17.1954C6.3617 15.7234 8.23858 14 12.2492 14"
          stroke="#971D1D"
          strokeWidth="1.5"
          strokeLinecap="round"
          strokeLinejoin="round"
